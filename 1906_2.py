...
exporter = pp.Exporter(gb, file_name='soluzione', folder_name='out/1906/')
...
exporter.write_vtu(['soluto_0', 'precipitato_0'], time_step=0)
...
for i in np.arange(1, int(T/DT)):
    ...
    soluto_0._values[:] = d[pp.STATE]['soluto']
    precipitato_0._values[:] = d[pp.STATE]['precipitato']
